...
class IndustryScreen extends React.Component {
            ...
            <View>
                <View style={{flexDirection: 'row', justifyContent: 'space-between' , alignItems: 'flex-start'}}>
                    <View style={{marginLeft:15, paddingBottom:8}}>
                        <Text style={styles.titleStyle}>{this.state.data.length + " Doanh nghiệp"}</Text>
                    </View>
                </View>
            </View>
        );
